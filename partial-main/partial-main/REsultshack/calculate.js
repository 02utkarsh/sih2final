$(document).ready(function() {
	...
	$("#calculate-btn").on("click", function() {
      ...
      formatScore=formatScore+"%"
			...
			console.log(name);
			document.getElementById("inamed").innerHTML = name;
            ...
            // Perform the index score calculation
            const indexScore = (totalScore * weight1) + (totScore * weight2) + (totScore * weight3);
									document.getElementById("index").innerHTML = indexScore;
			// display results
			$("#results").show();
